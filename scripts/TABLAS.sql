...
ALTER TABLE Venta ADD FOREIGN KEY (visitante_id) REFERENCES Visitante (id);

ALTER TABLE Entrada ADD FOREIGN KEY (parque_id) REFERENCES Parque (id);
...
ALTER TABLE LineaVenta ADD FOREIGN KEY (tipo_visitante_id) REFERENCES TipoVisitante (id);
ALTER TABLE LineaVenta ADD FOREIGN KEY (entrada_id) REFERENCES Entrada (id);
