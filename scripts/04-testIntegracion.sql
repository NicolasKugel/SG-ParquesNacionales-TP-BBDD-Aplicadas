...
EXEC sp_ImportarDatosParqueUpsert
...
EXEC sp_ABM_Entrada 'I', NULL, 5000.00, 1, '2026-01-01';

-- 4. Alta de Visitante via SP
EXEC sp_ABM_Visitante 'I', NULL, 'Juan', 'Pérez', '35123456';
...
EXEC sp_ABM_Guia 'I', NULL, 'Carlos', 'Gómez', '22987654', 'Lic. Biología', 'Provincial', 'Aves';

EXEC sp_ABM_Atraccion 'I', NULL, 'Garganta del Diablo', 'Paseo en pasarelas superiores',
...
EXEC sp_ABM_GuardaParque 'I', NULL, 'Roberto', 'Cáceres', '28765432', 1;
...
EXEC sp_ABM_GuardaParque 'U', @idGP, 'Roberto', 'Cáceres', '28765432', 0;
...
PRINT '---------------------------------------------------------';
BEGIN TRY
    EXEC sp_ABM_GuardaParque 'I', NULL, '', '', '123', 9;
END TRY
BEGIN CATCH
    PRINT ERROR_MESSAGE();
END CATCH;
...
PRINT '---------------------------------------------------------';
BEGIN TRY
    EXEC sp_ABM_GuardaParque 'I', NULL, 'Ana', 'Ríos', '28765432', 1;
END TRY
BEGIN CATCH
    PRINT ERROR_MESSAGE();
END CATCH;
...
DECLARE @idGP INT = (SELECT id FROM Personal.GuardaParque WHERE dni = '28765432');
EXEC sp_ABM_AsignacionGuardaParque 'I', NULL, '2026-01-15', NULL, NULL, @idGP, 1;
...
EXEC sp_ABM_AsignacionGuardaParque 'U', @idAsig, '2026-01-15', '2026-06-20',
...
PRINT '---------------------------------------------------------';
BEGIN TRY
    EXEC sp_ABM_AsignacionGuardaParque 'I', NULL, '2026-06-01', '2026-05-01',
        NULL, 9999, 9999;
END TRY
BEGIN CATCH
    PRINT ERROR_MESSAGE();
...
EXEC sp_ABM_Atraccion 'I', NULL, 'Senda Macuco',
...
EXEC sp_ABM_Atraccion 'U', @idATR, 'Senda Macuco',
...
PRINT '---------------------------------------------------------';
BEGIN TRY
    EXEC sp_ABM_Atraccion 'I', NULL, '', NULL, '01:00:00', 0, -200.00, 9999;
END TRY
BEGIN CATCH
    PRINT ERROR_MESSAGE();
END CATCH;
...
EXEC sp_ABM_Visitante 'I', NULL, 'María', 'González', '41987654';
...
EXEC sp_ABM_Visitante 'U', @idVIS, 'María Laura', 'González', '41987654';
...
PRINT '---------------------------------------------------------';
BEGIN TRY
    EXEC sp_ABM_Visitante 'I', NULL, '', '', '12';
END TRY
BEGIN CATCH
    PRINT ERROR_MESSAGE();
END CATCH;
...
PRINT '---------------------------------------------------------';
BEGIN TRY
    EXEC sp_ABM_Visitante 'I', NULL, 'Pedro', 'Sosa', '41987654';
END TRY
BEGIN CATCH
    PRINT ERROR_MESSAGE();
END CATCH;
...
EXEC sp_ABM_Atraccion 'I', NULL, 'Tour Nocturno de Fauna',
...
EXEC sp_ABM_AtraccionGuia 'U', @idAG, '2026-07-01', 'Tarde', @idAtrF, @idG1;
...
PRINT '---------------------------------------------------------';
BEGIN TRY
    EXEC sp_ABM_AtraccionGuia 'U', 9999, '2026-07-01', '', 9999, 9999;
END TRY
BEGIN CATCH
    PRINT ERROR_MESSAGE();
END CATCH;
...
EXEC sp_ABM_AtraccionGuia 'D', @idAG;
...
EXEC sp_ABM_Empresa 'I', NULL, 'Concesiones del Sur S.A.', '30-12345678-9', 'Gastronomía';
EXEC sp_ABM_Concesion 'I', NULL, '2026-01-01', '2027-01-01', 100000.00, 1, 1;
EXEC sp_RegistrarPagoConcesion 1, '2026-02-05', '2026-01-01', 60000.00; -- queda Atrasado
GO
...
EXEC sp_ABM_PagoConcesion 'U', @idPago, '2026-02-10', '2026-01-01', 'Pagado', 100000.00, 1;
...
PRINT '---------------------------------------------------------';
BEGIN TRY
    EXEC sp_ABM_PagoConcesion 'U', 9999, '2026-03-01', '2026-02-01', 'Rechazado', -500.00, 9999;
END TRY
BEGIN CATCH
    PRINT ERROR_MESSAGE();
END CATCH;
...
PRINT '---------------------------------------------------------';
BEGIN TRY
    EXEC sp_ABM_PagoConcesion 'D', 9999;
END TRY
BEGIN CATCH
    PRINT ERROR_MESSAGE();
END CATCH;
